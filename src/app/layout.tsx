  ...
  return (
    ...
    >
      ...
      <body className="min-h-full flex flex-col bg-background text-foreground" suppressHydrationWarning>
        <ThemeProvider>
          <header className="fixed top-0 left-0 right-0 z-50 px-6 pt-6 sm:px-12 sm:pt-8 flex flex-col items-stretch">
            <SiteHeader />
          </header>
          <main className="flex-1 flex flex-col pt-[123px] sm:pt-[155px] overflow-x-clip">
