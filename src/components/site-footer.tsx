            ...
            return (
              <li key={social.id}>
                <a
                  ...
                  className="flex items-center justify-center size-10 rounded-full text-muted hover:text-foreground hover:bg-surface border border-transparent hover:border-border transition-colors"
                >
                  {Icon ? <Icon /> : null}
                </a>
              </li>
